...
typedef enum _jaiabot_sensor_protobuf_CalibrationType { 
    ...
    jaiabot_sensor_protobuf_CalibrationType_STOP_CALIBRATION = 18 /* stop calibration and return to normal operation */
} jaiabot_sensor_protobuf_CalibrationType;

/* Struct definitions */
typedef struct _jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer { 
    bool has_fluorometer_offset;
    double fluorometer_offset; 
    bool has_fluorometer_calibration_coefficient;
    double fluorometer_calibration_coefficient; 
    bool has_fluorometer_serial_number;
    uint64_t fluorometer_serial_number; 
} jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer;
...
typedef struct _jaiabot_sensor_protobuf_CalibrationCoefficients { 
    bool has_fluorometer;
    jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer fluorometer; 
} jaiabot_sensor_protobuf_CalibrationCoefficients;
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_init_default {false, jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_init_default}
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_init_default {false, 0, false, 0, false, 0}
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_init_zero {false, jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_init_zero}
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_init_zero {false, 0, false, 0, false, 0}
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_fluorometer_offset_tag 1
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_fluorometer_calibration_coefficient_tag 2
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_fluorometer_serial_number_tag 3
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_fluorometer_tag 1
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, MESSAGE,  fluorometer,       1)
#define jaiabot_sensor_protobuf_CalibrationCoefficients_CALLBACK NULL
#define jaiabot_sensor_protobuf_CalibrationCoefficients_DEFAULT NULL
#define jaiabot_sensor_protobuf_CalibrationCoefficients_fluorometer_MSGTYPE jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer

#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, DOUBLE,   fluorometer_offset,   1) \
X(a, STATIC,   OPTIONAL, DOUBLE,   fluorometer_calibration_coefficient,   2) \
X(a, STATIC,   OPTIONAL, UINT64,   fluorometer_serial_number,   3)
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_CALLBACK NULL
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_DEFAULT NULL
...
extern const pb_msgdesc_t jaiabot_sensor_protobuf_CalibrationCoefficients_msg;
extern const pb_msgdesc_t jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_msg;
...
#define jaiabot_sensor_protobuf_CalibrationCoefficients_fields &jaiabot_sensor_protobuf_CalibrationCoefficients_msg
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_fields &jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_msg
#define jaiabot_sensor_protobuf_SensorThreadConfig_fields &jaiabot_sensor_protobuf_SensorThreadConfig_msg

/* Maximum encoded size of messages (where known) */
#define jaiabot_sensor_protobuf_CalibrationCoefficients_Fluorometer_size 29
#define jaiabot_sensor_protobuf_CalibrationCoefficients_size 31
