...
#define jaiabot_sensor_protobuf_TurnerCFluor_init_default {false, 0}
#define jaiabot_sensor_protobuf_TurnerCFluor_init_zero {false, 0}
...
#define jaiabot_sensor_protobuf_TurnerCFluor_size 9
