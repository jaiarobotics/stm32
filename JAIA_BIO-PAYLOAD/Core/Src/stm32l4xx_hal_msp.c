...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC4     ------> ADC1_IN13
    */
    GPIO_InitStruct.Pin = THERMISTOR_Pin|GPIO_PIN_2|GPIO_PIN_3|AN_NTC_DO_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC4     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(GPIOC, THERMISTOR_Pin|GPIO_PIN_2|GPIO_PIN_3|AN_NTC_DO_Pin);

    HAL_GPIO_DeInit(GPIOA, AN_NTC_PH_Pin|GPIO_PIN_7);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  else if(htim_ic->Instance==TIM2)
  {
    ...
    PA0     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(PHASE_C_GPIO_Port, PHASE_C_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM16)
  {
    ...
    PB8     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(PHASE_B_GPIO_Port, PHASE_B_Pin);
